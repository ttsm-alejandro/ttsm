...
function importPhpFiles(){
    ...
    require "../../util/Util.php";
    //models
    require "../../models/MachineModel.php";
    //services
    require "../../services/MachineService.php";
}
...
function returnDataDELETE( $link ){
    $id = $_GET[ "id" ];
    echo MachineService::delete( $link , $id );
}
...
function returnDataPOST( $link ){
    ...
    $returnInfo = MachineService::save( $link , $newElement );
    echo $returnInfo;
}
...
function returnDataGET( $link ){
    if( isset( $_GET[ "id" ] ) ){
        $id = $_GET[ "id" ];
        echo json_encode( MachineService::getById( $link , $id ) );
    }else{
        echo json_encode( MachineService::getAll( $link ) );
    }
}
