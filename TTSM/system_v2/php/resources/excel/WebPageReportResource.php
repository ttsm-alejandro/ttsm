...
function importPhpFiles(){
    ...
    require "../../util/Util.php";
    //models
    require "../../models/WebPageReportModel.php";
    //services
    require "../../services/WebPageReportService.php";
}
...
function returnDataGET( $link , $table ){
    echo json_encode( WebPageReportService::getAll( $link , $table ) );
}
