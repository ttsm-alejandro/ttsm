...
<html>
    <head>
        ...
        <!-- Controller -->
        <script src="../../js/catalogs/cityCtrl.js"></script>
    </head>
            ...
            <div class="row">
                ...
                <?php if( !isset( $_GET[ "id" ] ) ){ ?>
                    ...
                    <div class="col-lg-3">
                        <div class="input-group">
                            <select ng-model="filterState" ng-options=" x.id as x.name for x in stateCatalog" class="form-control"></select>
                            <input class="form-control" ng-model="filterCityName">
                            <span ng-click="filterState = ''; filterCityName = '';" class="input-group-addon"><i class="glyphicon glyphicon-repeat"></i></span>
                        </div>
                        <div style="overflow: scroll; max-height: {{ userScreenHeight }};">
                            <table class="table table-hover">
                                ...
                                <tr ng-repeat="row in tableContent | filter : { idState : filterState , name : filterCityName } " 
                                    ng-click="getDetails( row )"
                                    ng-show="((row.idState === filterState) && ( filterState !== '' )) || (filterState === '')"
                ...
                <div class="col-lg-9">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr><th>State:</th><td><select ng-model="details.idState" ng-options=" x.id as x.name for x in stateCatalog" class="form-control"></select></td></tr>
